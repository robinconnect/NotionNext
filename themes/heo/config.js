const CONFIG = {
  ...
  SITE_CREATE_TIME: '2023-10-05', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  NOTICE_BAR: [
    { title: '', url: '' },
    { title: '联合大湾区所有做国际业务的小伙伴', url: 'http://robinconnect.com' }
  ],
  ...
  HERO_CATEGORY_3: { title: '生活锦囊', url: '/tag/生活锦囊' },
  ...
  INFO_CARD_URL: 'https://robinconnect.com', // 个人资料底部按钮链接
  ...
  SOCIAL_CARD_URL: 'https://robinconnect.com',
